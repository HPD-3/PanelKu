export function createCircularProgressBar1(ctx, initialValue = 0) {
...
document.addEventListener("DOMContentLoaded", async () => {
    const canvas = document.getElementById("progressCanvas1");
    if (!canvas) {
    ...
    try {
        ...
        createCircularProgressBar1(progressCtx, data.dataInput1);
    } catch (error) {
